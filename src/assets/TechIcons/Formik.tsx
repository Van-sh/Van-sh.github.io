...
function Formik(props: SVGProps<SVGSVGElement>) {
   return (
      <svg viewBox="0 0 34.7 34.7" width="24" height="24" xmlns="http://www.w3.org/2000/svg" {...props}>
         <g fill="#0051cd" transform="matrix(.400018502 0 0 .400018502 5.34987738 .55385626)">
